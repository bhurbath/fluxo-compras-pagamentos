import { criarContaContabilAction } from "@/app/admin/actions";
...
export default async function NovaContaContabilPage({
  searchParams,
}: {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-xl font-semibold">Nova conta contábil</h1>
      <ErroMensagem erro={erro} />
      <NomeSimplesForm
        label="Nome"
        action={criarContaContabilAction}
        submitLabel="Criar conta contábil"
      />
    </div>
  );
}
